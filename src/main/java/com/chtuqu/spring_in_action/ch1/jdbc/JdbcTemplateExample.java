package com.chtuqu.spring_in_action.ch1.jdbc;

import com.chtuqu.spring_in_action.ch1.jdbc.entities.Employee;
...
public class JdbcTemplateExample {
    ...
    public static void main(String[] args) {
        ClassPathXmlApplicationContext applicationContext = new ClassPathXmlApplicationContext("ch1/spring/jdbc-config.xml");
